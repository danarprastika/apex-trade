...
async def get_profile(
    ...
    return await risk_service.get_profile(current_user.id)
...
async def create_profile(
    ...
    return await risk_service.create_profile(
        user_id=user_id,
...
async def list_events(
    ...
    return await risk_service.list_events(current_user.id)
...
async def create_event(
    ...
    return await risk_service.log_event(
        user_id=payload.user_id or current_user.id,
...
async def validate_risk(
    ...
    risk_service: Annotated[RiskService, Depends(get_risk_service)] = None,
):
    return await risk_service.evaluate(current_user.id, risk_score, requested_position_size)
